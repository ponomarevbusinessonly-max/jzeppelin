  ...
  return (
    <main className="flex-1 w-full px-6 md:px-16 lg:px-24 pt-32 pb-20 relative overflow-hidden">
      ...
      <section ref={heroRef} className="relative">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start mb-24 relative z-10">
          ...
          <motion.div
            ...
            whileHover={{ y: -4 }}
          >
            <Image src="/products/THCParent.jpg" alt="THC Parent Test — J.Zeppelin"
      ...
      >
        ...
        <motion.h2 variants={fadeUp} className="font-heading text-4xl md:text-5xl tracking-tight mb-10 relative z-10">
          {d.whatMakesDifferent}
        </motion.h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10">
          {d.comparisons.map((c) => (
            ...
            >
              ...
              <div className={`font-body text-sm mb-4 ${c.highlight ? 'text-background/70' : 'text-muted-foreground'}`}>{d.detectionWindow}: {c.window}</div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 relative z-10">
          {d.steps.map((step) => (
            <motion.div key={step.num} variants={fadeUp} whileHover={{ y: -5, borderColor: 'rgba(0,0,0,0.4)' }}
              transition={{ type: 'tween', duration: 0.3 }} className="border border-border p-6 bg-background/70 backdrop-blur-sm">
      ...
      >
        ...
        <motion.a href={(locale === 'uk' || locale === 'de') ? `/${locale}/#buy` : '/#buy'} className="px-8 py-4 bg-foreground text-background font-heading text-xl tracking-wide hover:bg-foreground/90 transition-colors"
