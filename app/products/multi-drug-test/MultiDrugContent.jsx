...
// Panel codes/names/cutoffs never change by locale
const panels = [
    ...
    <main className="flex-1 w-full px-6 md:px-16 lg:px-24 pt-32 pb-20 relative overflow-hidden">
      ...
      >
        <div className="float-rotate">
          <Image src="/visualelements/capsule.png" alt="" width={260} height={260}
      ...
      >
        <div className="sketch-float">
          <Image src="/visualelements/smilepill.png" alt="" width={220} height={220}
      ...
      >
        <div className="sketch-float-alt">
          <Image src="/visualelements/starpill.png" alt="" width={210} height={210}
      ...
      >
        <div className="drift-float">
          <Image src="/visualelements/pill.png" alt="" width={240} height={240}
      ...
      >
        <div className="sketch-float">
          <Image src="/visualelements/pill2.png" alt="" width={220} height={220}
            className="w-40 h-40 lg:w-48 lg:h-48 object-contain"
      ...
      <motion.div
        ...
        transition={{ duration: 1.0, ease }}
      >
        <Image src="/visualelements/syringe.png" alt="" width={420} height={210}
      ...
      >
        <div className="sketch-float-alt">
          <Image src="/visualelements/alienpill.png" alt="" width={200} height={200}
            className="w-36 h-36 lg:w-44 lg:h-44 object-contain"
            style={{ mixBlendMode: 'multiply' }} />
        </div>
      </motion.div>
      ...
      >
        <div className="drift-float">
          <Image src="/visualelements/weed2.png" alt="" width={280} height={280}
      ...
      >
        <div className="sketch-float-slow">
          <Image src="/visualelements/umbrella1.png" alt="" width={420} height={420}
            className="w-72 lg:w-96 h-auto object-contain"
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start mb-24">
          ...
          >
            <Image src="/products/MultiTest.jpg" alt="Multi-Drug Rapid Test — J.Zeppelin"
              fill className="object-cover" sizes="(max-width: 1024px) 100vw, 384px" />
          </motion.div>
        </div>
        ...
        <div className="mb-24 relative">
          ...
          <p className="mt-3 text-xs text-muted-foreground/50 font-body">{d.cutoffNote}</p>
        </div>
        ...
        <div className="mb-24">
          ...
          >
            {d.steps.map((step) => (
              <motion.div key={step.num} variants={fadeUp} whileHover={{ y: -4 }}
                transition={{ duration: 0.25, ease }} className="border border-border p-6 bg-background">
          ...
          <p className="mt-4 text-xs text-muted-foreground/50 font-body max-w-lg">{d.collectionNote}</p>
        </div>

        {/* Key facts + Limitations */}
        <div className="mb-24 grid grid-cols-1 md:grid-cols-2 gap-8">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.75, ease }}>
            ...
            <motion.ul variants={staggerContainer} initial="hidden" whileInView="visible"
              viewport={{ once: true, margin: '-60px' }} className="space-y-4">
              {d.facts.map((fact) => (
                <motion.li key={fact} variants={fadeUp} className="flex items-start gap-3 font-body text-sm">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }}
            ...
            <ul className="space-y-3 font-body text-sm text-muted-foreground leading-relaxed">
              {d.limitationsList.map((l, i) => <li key={i}>{l}</li>)}
            </ul>
          </motion.div>
        </div>
        ...
        <div className="mb-24">
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible"
            viewport={{ once: true, margin: '-60px' }} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.a href={(locale === 'uk' || locale === 'de') ? `/${locale}/#buy` : '/#buy'} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}
